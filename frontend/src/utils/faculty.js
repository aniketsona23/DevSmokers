export const viewStudentApp = [
  { field: "studentName", header: "Student Name", width: 120 }, // Adjust the width as needed
  { field: "projectTitle", header: "Project Title", width: 120 }, // Adjust the width as needed
  { field: "studentId", header: "Student ID", width: 100 }, // Adjust the width as needed
  { field: "gpsrn", header: "GPSRN", width: 80 }, // Adjust the width as needed
  { field: "date", header: "Date", width: 80 }, // Adjust the width as needed
  { field: "status", header: "Status", width: 100 }, // Adjust the width as needed
  { field: "", header: "", width: 60 }, // Adjust the width as needed
];
